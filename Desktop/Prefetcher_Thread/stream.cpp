    ...
    Vector& a, Vector& b, Vector& c)
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Main Loop
    std::vector<std::vector<double> > timing(5, std::vector<double>(iterations));
...
int hpx_main(boost::program_options::variables_map& vm)
{
    ...
    std::vector<std::vector<double> > timing(5, std::vector<double>(iterations, 0.0));
    ...
    std::vector<double> avgtime(5, 0.0);
    std::vector<double> mintime(5, (std::numeric_limits<double>::max)());
    std::vector<double> maxtime(5, 0.0);
