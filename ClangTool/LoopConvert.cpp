...
struct statistics
{
    ...
    unsigned num_threads;               // will be assigned with runtime
    unsigned num_lambda_iterations;     // will be re-assigned with runtime
    unsigned num_ops;                   
...
class ForEachCallVisitor : public RecursiveASTVisitor<ForEachCallVisitor>
{
public:
    explicit ForEachCallVisitor(ASTContext* context, std::string fname) : m_context(context), fName(fname) 
    {
...
public:
                                                 ...
                                                 StringRef file) override 
    {
        ...
        //const std::string fName = "hpx::parallel::for_each";
