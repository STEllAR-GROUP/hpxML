...
{    
    ...
    const double bytes[3] = {
        ...
        7 * sizeof(STREAM_TYPE) * static_cast<double>(vector_size)
        // FIXME
        // +30 instructions in calling prefetching NOT SURE: (7 * sizeof(STREAM_TYPE) * static_cast<double>(vector_size) + 12 * sizeof(int) * static_cast<double>(vector_size) + 18 * sizeof(int))
    };
